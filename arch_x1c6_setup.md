...
- **Stability:** Use well-tested configurations and official packages from Arch repositories.
- **Security:** Implement a basic firewall and keep the system updated.
- **Optimization:** Configure power profiles for both AC (balanced) and Battery (longevity) use, tailored for the X1C6 hardware.
- **Longevity:** Use settings that are gentle on the hardware, especially the old battery.

## Hardware
- **Model:** Lenovo ThinkPad X1 Carbon 6th Gen (20KG)
- **RAM:** 16GB
...
## Phase 2: Desktop Customization (Future Goal)

This section contains the steps to install and configure the XFCE desktop environment.

### 1. Install XFCE and Display Manager
```bash
sudo pacman -S xfce4 xfce4-goodies lightdm lightdm-gtk-greeter
```

### 2. Enable the Display Manager
This will start the graphical login screen on boot.
```bash
sudo systemctl enable lightdm.service
```

### 3. Further Customization
Your notes contain extensive details on:
-   Customizing the XFCE panel, icons, and themes to look like macOS.
-   Setting up a global menu and a dock (Plank).
-   Configuring Windows-like keyboard shortcuts.

When you are ready to proceed with this, we can refer back to those detailed notes.
